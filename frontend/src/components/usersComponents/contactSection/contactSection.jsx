      ...
      <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-10 backdrop-blur-md bg-white/10 border border-white/30 rounded-3xl p-8 md:p-12 shadow-[0_10px_40px_rgba(0,255,255,0.2)]">
        ...
        >
          ...
          <div>
            ...
            <p>support@showhub.com</p>
            <p>info@showhub.com</p>
          </div>
          <div>
            <h3 className="font-semibold text-cyan-400 mt-4">Socials</h3>
            <p>Instagram: @showhub</p>
            <p>Twitter: @showhub</p>
          </div>
        </motion.div>
        ...
        <div>
          ...
          >
            <h3 className="text-2xl font-bold mb-6 bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-500 text-transparent bg-clip-text">
              Send a Message
            </h3>
          </motion.div>
          ...
          >
            <div>
              ...
              <input name="status" value="Contact" type="hidden" />
              <input
                name="name"
                value={formData.name}
