        ...
        <div>
          ...
          >
            <div>
              ...
              <input name="staus" value="Contact" type="hidden" />
              <input
                name="name"
                autoComplete="off"
                value={formData.name}
            ...
            <div>
              ...
              <input
                ...
                type="tset"
                className="w-full p-2 rounded-lg bg-white/20 placeholder-white/70 text-white"
                placeholder="https://plus.unsplash.com/premium_photo-1664474619075-644dd191935f?fm=jpg&q=60&w=3000&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8aW1hZ2V8ZW58MHx8MHx8fDA%3D"
              />
            </div>
            <div>
